              ...
              <div className="px-6 space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="font-dm-sans text-muted-foreground">+44 114 XXX XXXX</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="font-dm-sans text-muted-foreground">info@scuffsetc.co.uk</p>
                  </div>
                </div>
              ...
              <form className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input className="bg-input border-border flex h-9 w-full rounded-md border px-3 py-1 text-base shadow-xs focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]"
                      placeholder="John" />
                  </div>
                  <div>
                    <label className="font-dm-sans text-sm font-medium text-card-foreground mb-2 block">
                ...
                <div>
                  ...
                  <textarea placeholder="Please describe the damage and any specific requirements..."
                    className="bg-input border-border flex w-full rounded-md border px-3 py-2 text-base shadow-xs min-h-[120px] focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]"></textarea>
                </div>
